...
def ack_reader(number,timestamp):
    global last_ack, repitation_count, window, TCP_Mode, window_size
...
def on_triple_ack(number):
    global ssthreshold, window_size, TCP_Mode, missing_segment
...
while True:
	...
	print >> sys.stderr, time.time(), window_size, a[1]
